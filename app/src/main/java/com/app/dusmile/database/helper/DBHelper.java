package com.app.dusmile.database.helper;
...
public class DBHelper extends SQLiteOpenHelper {
  ...
  /*  //ApplicationTable
    ...
    public void truncateDatabase() {
        ...
        db.execSQL("DELETE TABLE IF EXISTS "+TABLE_LOGIN_JSON_TEMPLATE);
        db.execSQL("DELETE TABLE IF EXISTS "+TABLE_CATEGORY);
        db.execSQL("DELETE TABLE IF EXISTS "+TABLE_SUB_CATEGORY);
        db.execSQL("DELETE TABLE IF EXISTS "+TABLE_CLIENT_TEMPLATE);
        db.execSQL("DELETE TABLE IF EXISTS "+TABLE_TEMPLATE_JSON);
        db.execSQL("DELETE TABLE IF EXISTS "+TABLE_DYNAMIC_FIELD_TABLE);
        db.execSQL("DELETE TABLE IF EXISTS "+TABLE_ASSIGNED_JOBS_TABLE);
        db.execSQL("DELETE TABLE IF EXISTS "+TABLE_ASSIGNED_JOBS_STATUS_TABLE);
        db.execSQL("DROP TABLE IF EXISTS "+TABLE_OFFLINE_ASSIGNED_JOBS);
