...
public class SubProcessFieldDataResponse {
    ...
    public class SubProcessField {
        ...
        public Boolean getMultipleTextBox() {
            return isMultipleTextBox;
        }

        public void setMultipleTextBox(Boolean multipleTextBox) {
            isMultipleTextBox = multipleTextBox;
        }
        ...
        public Boolean getYearMonthCombo() {
            return isYearMonthCombo;
        }

        public void setYearMonthCombo(Boolean yearMonthCombo) {
            isYearMonthCombo = yearMonthCombo;
        }
