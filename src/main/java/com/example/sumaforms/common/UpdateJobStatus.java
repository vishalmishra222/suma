...
import com.example.sumaforms.DBmodel.SubCategoryDB;
import com.example.sumaforms.application.DusmileApplication;
import com.example.sumaforms.fragment.PendingPdfUploadFragment;
                ...
                if (obj != null) {
                    ...
                    if (responseJsonObject.length() > 0) {
                        ...
                        if (success.equalsIgnoreCase("true")) {
                            ...
                            IOUtils.showSuccessMessage(mContext, strApp, "Pdf Uploaded Successfully");
                        } else {
                            AssignedJobsDB.removeJobByJobId(dbHelper, jobID);
                            AssignedJobsStatusDB.removeJobStatusByJobId(dbHelper, jobID);
                            ...
                            IOUtils.showSuccessMessage(mContext, strApp, responseJsonObject.getString("message"));
